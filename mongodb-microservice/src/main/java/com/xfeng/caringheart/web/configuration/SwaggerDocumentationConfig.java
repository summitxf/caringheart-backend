...
public class SwaggerDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("caringheart").description("caringheart api").license("").licenseUrl("")
	...
	public Docket customImplementation() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.xfeng.caringheart.web.api")).build()
